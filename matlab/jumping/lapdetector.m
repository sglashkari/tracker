function [lap, idx_analysis] = lapdetector(exp_directory, xmax, tai, taf)
...
%       (3) Time Analysis (Initial)
%       (4) Tiem Analysis (Final)
%
%   Outputs
...
load(mat_filename, 'pos', 'ppcm')
clearvars -except datafile exp_directory xmax tai taf pos ppcm offset;
